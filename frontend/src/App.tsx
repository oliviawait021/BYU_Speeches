                ...
                >
                  <div className="carousel-inner pt-5">
                    <div className="carousel-item active">
                      <Card
                        title="Jesus Christ"
                        image="/src/img/jesus.webp"
                        imgSize={{ width: "200px", height: "220px" }}
                      />
                    </div>
                    <div className="carousel-item">
                      <Card
                        title="Faith"
                        image="/src/img/faith.jpg"
                        imgSize={{ width: "200px", height: "220px" }}
                      />
                    </div>
                    <div className="carousel-item">
                      <Card
                        title="Service"
                        image="/src/img/service.jpeg"
                        imgSize={{ width: "200px", height: "220px" }}
                      />
                    </div>
                    <div className="carousel-item">
                      <Card
                        title="Temples and Families"
                        image="/src/img/washington_dc_temple.webp"
                        imgSize={{ width: "200px", height: "220px" }}
                      />
                    </div>
                  </div>
              ...
              <Card title="Study Tools">
                <div className="container text-left mt-4 pb-5">
                  <div className="d-flex justify-content-center">
                    <div
                      className="card bg-dark text-white p-3 rounded shadow-lg"
                      style={{ width: "90%" }}
                    >
                      <div className="row text-center">
                        ...
                        <div className="col-sm-2">
                          <div className="d-flex flex-column align-items-center">
                            ...
                            <p className="mt-2 text-info fw-bold">Favorites</p>
                          </div>
                        </div>
                        <div className="col-sm-2">
                          <div className="d-flex flex-column align-items-center">
                            <i className="bi bi-bookmark text-info fs-1"></i>
                            <p className="mt-2 text-info fw-bold">
                              Saved Speeches
                            </p>
                          </div>
                        </div>
